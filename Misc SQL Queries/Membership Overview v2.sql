...
create table ##Membership_Overview (Month_Year varchar(15), DateSort varchar(15), Joins int default 0, Rejoins int default 0, Suspends int default 0, Member_Count int default 0)
